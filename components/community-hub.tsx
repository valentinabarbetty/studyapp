  ...
  return (
    <div className="p-6 animate-fade-in">
      ...
      <div className="mb-10">
        ...
        {/* ya no dependemos tanto del space-y, usamos mb en la card */}
        <div className="space-y-0">
          {myGroups.map((group) => (
            <Link
              ...
              className="block"
            >
              <Card className="mb-8 p-6 bg-card border-border hover:border-primary transition-colors cursor-pointer">
